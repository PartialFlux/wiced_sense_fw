...
*/
HTS221_Error_et HTS221_Get_DriverVersion(HTS221_DriverVersion_st* ver)
{
  ver->Major = HTS221_DRIVER_VERSION_MAJOR;
  ver->Minor = HTS221_DRIVER_VERSION_MINOR;
  ver->Point = HTS221_DRIVER_VERSION_POINT;
  
  return HTS221_OK;
}

/**
* @brief  Read HTS221 registers.
*         This function must be implemented by user according to the hardware used.
...
* @retval Error code [HTS221_OK, HTS221_ERROR].
*/
HTS221_Error_et HTS221_ReadReg(uint8_t regAddr, uint8_t numByteToRead, uint8_t* data)
{
...
* @retval Error code [HTS221_OK, HTS221_ERROR].
*/
HTS221_Error_et HTS221_WriteReg(uint8_t regAddr, uint8_t numByteToWrite, uint8_t* data)
{
	CFA_BSC_STATUS read_status;
	UINT8 i;
    ...
    read_status = cfa_bsc_OpExtended(reg_data_bytes, numByteToWrite + 1, NULL, 0, HTS221_I2C_ADDRESS, I2C_SLAVE_OPERATION_WRITE);
